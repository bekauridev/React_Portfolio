  ...
  return (
    <ol className="relative border-s border-slate-700/50">
      <TimeLineCard
        ...
        description="I acquired a solid foundation of my programming knowledge, focusing on core concepts,
        ...
        learningPlaceLink="https://www.profgldani.ge/en"
      />
      <TimeLineCard
        date="September 2024"
      ...
      <TimeLineCard
        ...
        learningPlaceLink="https://www.interbusiness.edu.ge/en"
      />
    </ol>
  );
}
